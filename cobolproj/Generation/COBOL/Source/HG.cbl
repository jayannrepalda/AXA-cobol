       ...
       Data Division.
        ...
        FD IN-INTERNAL-FILE
             record is varying from 1 to 80 characters
               DEPENDING ON IN-FILE-RECORD-LENGTH
        ...
        FD OUT-INTERNAL-FILE
             ...
             record is varying from 1 to 80 characters
               DEPENDING ON OUT-FILE-RECORD-LENGTH
      ...
      *
       Working-Storage Section.
        ...
        77 IN-FILE-RECORD-LENGTH pic 9(5).
        77 OUT-FILE-RECORD-LENGTH pic 9(5).
      ...
      *    Assume text to be written to OUT-INTERNAL-FILE is in Temp-data
           MOVE 80 TO OUT-FILE-RECORD-LENGTH.
           IF OUT-FILE-RECORD-LENGTH > IN-FILE-RECORD-LENGTH
              MOVE IN-FILE-RECORD-LENGTH TO OUT-FILE-RECORD-LENGTH
           END-IF.
           IF OUT-FILE-RECORD-LENGTH > 80
              MOVE 80 TO OUT-FILE-RECORD-LENGTH
           END-IF.
           Move Temp-data(1:OUT-FILE-RECORD-LENGTH) TO
                    OUT-FILE-RECORD(1:OUT-FILE-RECORD-LENGTH).
